...
const rules = [
  ...
  },
  {
    ...
    items: [
      ...
      '점프볼한 선수는 공을 직접 잡거나 첫 번째 패스를 받을 수 없다.',
  ...
  },
  {
    ...
    noteTitle: '헤드어택 규정',
    noteItems: [
      '머리를 직접 맞힌 공격은 원칙적으로 아웃이 아니다. 다만 예외 상황에서는 아웃으로 판정할 수 있다.',
  ...
  },
  {
    ...
    subsections: [
      ...
      },
      {
        title: '3) 5초 룰',
        items: [
          '공을 가진 선수가 경기 진행 의사 없이 공을 들고 있으면 5초 룰을 적용한다.',
          '경기 진행 의사가 없다고 주심이 판단한 이후 5초 룰을 적용한다. 주심은 오른쪽 손가락을 하나씩 접으면서 5초를 카운트 한다.',
  ...
  return (
    <section className="view standings-view">
      ...
      <aside className="info-panel indigo">
        <h2>순위 산정 규칙</h2>
        <p>경기 승리 3점, 무승부 2점, 패배 1점입니다. 총점이 같으면 승수가 많은 학급이 앞에 옵니다.</p>
      </aside>
    </section>
  );
}
